...
def changeTileInTILES(oldtile_str, newtile_str, file_lines):
    ...
    if newtile_oldline and oldtile_oldline:
        ...
        print("newtile is empty tile! put old in the empty place and remove it from previous place")
        ...
        print("oldtile is empty tile! put new in an empty place and remove it from previous place")
